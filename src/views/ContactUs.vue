      ...
      <div class="flex-container" style="display: flex; flex-wrap: wrap; justify-content: space-between;">
        ...
        <div class="information" style="flex: 1 1 auto; max-width: 25%;">
          <div class="text-lg font-light text-navy-prim mb-3 mt-4 flex items-center">
            <img src="src\assets\img\icon\phone.svg" alt="Icon"
      ...
      <div class="grid grid-cols-2 gap-5">
        <div class="mb-4">
          ...
          <input v-model="name"
            ...
            id="name" type="text" placeholder="Masukkan nama Anda" style="border-bottom: 2px solid #4A5568;">
        </div>
        <div class="mb-4">
          ...
          <input v-model="company"
            class="shadow-none appearance-none border-none bg-transparent w-full py-2 px-3 text-gray-700 leading-tight focus:ring-0"
            id="company" type="text" placeholder="Masukkan nama perusahaan" style="border-bottom: 2px solid #4A5568;">
        </div>
        <div class="mb-4">
          ...
          <input v-model="email"
            class="shadow-none appearance-none border-none bg-transparent w-full py-2 px-3 text-gray-700 leading-tight focus:ring-0"
            id="email" type="email" placeholder="Masukkan alamat email" style="border-bottom: 2px solid #4A5568;">
        </div>
        <div class="mb-4">
          ...
          <input v-model="phone"
            class="shadow-none appearance-none border-none bg-transparent w-full py-2 px-3 text-gray-700 leading-tight focus:ring-0"
            id="phone" type="text" placeholder="Masukkan nomor telepon" style="border-bottom: 2px solid #4A5568;">
        </div>
      </div>
      <div class="mb-6">
        ...
        <textarea v-model="message"
          class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-0"
          id="message" rows="6" placeholder="Tulis pesan Anda di sini..."></textarea>
      </div>
      <div class="flex items-center justify-center">
        <button class="bg-navy-prim hover:bg-blue-700 text-white font-light py-2 px-4 rounded focus:ring-0"
